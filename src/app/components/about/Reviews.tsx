...
// import { review } from '@/app/utils/data';
...
//     <div className="mt-24">
//       {/* Review Cards */}
//       <div className="flex items-center flex-warp justify-center gap-6 mx-auto mt-8">
//         {review
//           .slice(current * reviewsPerSlide, current * reviewsPerSlide + reviewsPerSlide)
//           .map((item) => (
//             <div
//               key={item.id}
//               className="max-w-sm   border bg-white relative"
//             >
//               {/* Image Section */}
...
//                   width={190}
//                   height={180}
//                   className="w-full mx-auto object-contain md:h-[430px]"
//                 />
//               </div>
